...
const filename = 'db/getdata7days.json';


async function fetchDataAndSave() {
    var apiUrl = 'https://api.ooni.io/api/v1/aggregation?probe_cc=DE&'+getDateRange(7)+'&time_grain=day&axis_x=measurement_start_day&axis_y=domain&test_name=web_connectivity';
